...
public static class HabitMappings
{
    public static readonly SortMappingDefinition<HabitDto, Habit> SortMapping = new()
    {
        ...
        [
            ...
            new SortMapping(nameof(HabitDto.HabitStatus), nameof(Habit.HabitStatus)),
            ...
            new SortMapping(nameof(HabitDto.LastComplitedAtUtc), nameof(Habit.LastComplitedAtUtc)),
        ]
    };
